...
field_zone_master |>
  ...
  mutate(Flat = Flat/total_reps,
         Shallow_SHC = Shallow_SHC/total_reps,
         Shallow_Middle = Shallow_Middle/total_reps,
         Out = Out/total_reps,
         SHC = SHC/total_reps,
         Middle_Hook = Middle_Hook/total_reps,
         Deep_Out = Deep_Out/total_reps,
         Deep_Middle = Deep_Middle/total_reps)
